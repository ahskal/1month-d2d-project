...
#define WALL_COLOR Color(100 / 255.0f * 0.5f,96 / 255.0f * 0.5f,75 / 255.0f * 0.5f, 0.5f)
#define TILE_COLOR Color(114 / 255.0f * 0.5f,117 / 255.0f * 0.5f,27 / 255.0f * 0.5f, 0.5f)
#define FIND_COLOR Color(0 / 255.0f * 0.5f,129 / 255.0f * 0.5f,36 / 255.0f * 0.5f, 0.5f)