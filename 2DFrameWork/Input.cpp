...
{
	// 변경코드
	mouseWorldPos.x = (mouseScreenPos.x - app.GetHalfWidth()) / CAM->scale.x + CAM->position.x;
	mouseWorldPos.y = (app.GetHalfHeight() - mouseScreenPos.y) / CAM->scale.y + CAM->position.y;
